...
import {LayoutDashboard,PlusSquare,Lamp,FolderClock,PackageCheck,Settings,LogOut} from 'lucide-react';
export default function Layout({children}:{children:React.ReactNode}){
 const nav=[['/','Tổng quan',LayoutDashboard],['/create','Create',PlusSquare],['/products','Sản phẩm',Lamp],['/projects','Dự án',FolderClock],['/production','Production',PackageCheck],['/settings','Cài đặt',Settings]] as const;
